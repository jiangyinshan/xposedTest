...
public class Backup implements IXposedHookLoadPackage {
            ...
            XposedHelpers.findAndHookMethod(Application.class, "attach",
                    Context.class, new XC_MethodHook() {
                        ...
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            ...
                            try {
                                hookclass = cl.loadClass("com.qisi.manager.PopupManager");
                            } catch (Exception e) {
                                Log.e("DEBUG", "xxxxhook load class error", e);
                                return;
                            }
                            Log.i("DEBUG", "xxxxhook load success");
                            XposedHelpers.findAndHookMethod(hookclass, "triggerPopup",CharSequence.class,
                                    new XC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
